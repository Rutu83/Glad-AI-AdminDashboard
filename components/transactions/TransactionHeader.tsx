...
export default function TransactionHeader() {
  ...
  return (
    <header className="px-8 py-8 flex flex-col gap-6 z-10 shrink-0">
      {/* Breadcrumbs */}
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div className="flex flex-col gap-2">
          <h2 className="text-3xl font-bold tracking-tight text-white">Live Transaction Feed</h2>
          <p className="text-text-secondary">Monitor incoming transactions and system events in real-time.</p>
        </div>
