...
export default function RevenueHeader() {
  return (
    <header className="flex-shrink-0 w-full bg-background-dark/95 backdrop-blur-md z-10 border-b border-white/5 sticky top-0">
      <div className="px-4 md:px-8 py-4 md:py-6 max-w-7xl mx-auto w-full pt-14 md:pt-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div className="flex flex-col gap-1">
            <h2 className="text-white text-2xl md:text-3xl font-black tracking-tight">Revenue & Subscriptions</h2>
            <p className="text-text-secondary text-xs md:text-sm font-normal">Overview of financial performance and subscription metrics</p>
          </div>
